        ...
        area(Content)
        {
            repeater(General)
            {
                ...
                field(chainName; Rec."Chain Name")
                {
                    ...
                    // }
                    // field(nonPaymtPeriodsCode; Rec."Non-Paymt. Periods Code")
                    // {
                    //     Caption = 'Non-Paymt. Periods Code';
                    // }
                    // field(notInAEAT; Rec."Not in AEAT")
                    // {
                    //     Caption = 'Not in AEAT';
                    // }
                    ...
                    // }
                    // field(paymentDaysCode; Rec."Payment Days Code")
                    // {
                    ...
                    // }
                    // field(rutCliente; Rec.Rut_Cliente)
                    // {
                ...
                field(codigoActividad; Rec.codigo_Actividad)
                {
